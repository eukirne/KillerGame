...
const sfx = {
  shoot(){
    playTone(920, 0.07, 'square', 0.22);
    playTone(1400, 0.04, 'sine', 0.08);
  },
  missile(){
    playTone(660, 0.1, 'sawtooth', 0.2, 440);
  },
  railgun(){
    playTone(200, 0.08, 'sawtooth', 0.3, 1800);
    playNoise(0.06, 0.2);
  },
  hit(){
    playNoise(0.05, 0.2);
  ...
  crash(){
    playNoise(0.2, 0.45);
    playTone(60, 0.25, 'sawtooth', 0.35, 30);
    playTone(180, 0.1, 'square', 0.2, 40);
  },
  pickup(){
